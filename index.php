    ...
    <!-- <section class="about-wthree py-3">
        <div class="container  py-sm-5">
            <div class="title-sec-w3layouts_pvt text-center">
                <span class="title-wthree">Bergabunglah dengan warjo company di seluruh Indonesia</span>
                <h4 class="w3layouts_pvt-head">Dapatkan pengalaman berharga</h4>
            </div>
        </div>
    </section> -->
    <!-- //about -->
            ...
            <div class="wthreepvt-pos-row row  text-center">
                <div class="col-lg-4 col-sm-6 wthreepvt-pos-grids">
                    <div class="p-md-5 p-sm-3">
                        ...
                        <p>We are looking for a qualified Computer Technician to install, maintain and repair computers and networks.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 wthreepvt-pos-grids  border-left border-right my-sm-0 my-5">
                    <div class="p-md-5 p-sm-3">
                        ...
                        <p>We are looking for a Marketing Analyst who’ll research and identify ways to build our brand and acquire new clients.</p>
                    </div>
                </div>
                <div class="col-lg-4 wthreepvt-pos-grids">
                    <div class="p-md-5 p-sm-3">
                        ...
                        <p>We are looking for a competitive Insurance Sales Representative to help us expand our business by actively seeking and acquiring new clients.</p>
                    </div>
                </div>
            </div>
            <div class="wthreepvt-pos-row border-top row text-center pb-lg-5 pt-md-0 pt-5 mt-md-0 mt-sm-5 mt-4">
                <div class="col-lg-4 col-sm-6 wthreepvt-pos-grids">
                    <div class="p-md-5 p-sm-3 col-label">
                        ...
                        <p>We are looking for a Customer Service Trainer to educate our support, sales and customer service teams by conducting seminars and interactive courses.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 wthreepvt-pos-grids mt-lg-0 mt-md-3 border-left border-right pt-sm-0 pt-5">
                    <div class="p-md-5 p-sm-3 col-label">
                        ...
                        <p>We are looking for a responsible Healthcare Administrator to coordinate our medical services.</p>
                    </div>
                </div>
                <div class="col-lg-4 wthreepvt-pos-grids pt-md-0 pt-5">
                    <div class="p-md-5 p-sm-3 col-label">
                        ...
                        <p>We are looking for a skilled Auto Mechanic to maintain and repair vehicles.</p>
                    </div>
                </div>
            </div>
        </div>
